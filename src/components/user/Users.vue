            ...
            <el-table :data="userlist" :border="true" :stripe="true">
                ...
                <el-table-column label="操作" width="180px">
                    <template slot-scope="scope">
                        ...
                        <!--删除按钮-->
                        <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeUserByld(scope.row.id)"></el-button>
...
export default{
    data(){
        ...
        //验证手机号的规则
        var vcheckMobile = (rules,values,cb)=>{}
        return {
            //获取用户列表的参数对象
            queryInfo:{
                query:'',
